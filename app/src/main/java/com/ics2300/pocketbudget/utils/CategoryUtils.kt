...
object CategoryUtils {
    ...
    fun getDefaultCategories(): List<CategoryEntity> {
        return listOf(
            ...
            CategoryEntity(name = "Savings", keywords = "SAVINGS,INVESTMENT,MMF,CHAMA", colorHex = getDefaultColorHex(10)),
            CategoryEntity(name = "Transfer & Cash", keywords = "SENT,TRANSFER,MPESA,POCHI,LA BIASHARA,TILL,PAYBILL,WESTERN UNION,MONEYGRAM,REMITLY,WORLDREMIT,WITHDRAW,AGENT,ATM,CASH,M-SHWARI,DEPOSIT,KCB,COOP,EQUITY,ABSA,STANCHART,NCBA,FAMILY BANK,I&M,DTB,BANK", colorHex = getDefaultColorHex(11)),
            CategoryEntity(name = "Income", keywords = "RECEIVED,DEPOSIT,SALARY,DIVIDEND,INTEREST,REFUND,COMMISSION,BONUS,STIPEND,PAYOUT,CASHBACK,GIFT,REWARD", colorHex = getDefaultColorHex(12))
        )
    }
