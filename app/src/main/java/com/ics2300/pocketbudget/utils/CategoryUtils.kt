...
object CategoryUtils {
    ...
    fun getDefaultCategories(): List<CategoryEntity> {
        return listOf(
            ...
            CategoryEntity(name = "Debt & Credit", keywords = "FULIZA,LOAN,CREDIT,REPAYMENT,OVERDRAFT", colorHex = getDefaultColorHex(10)),
            CategoryEntity(name = "Savings", keywords = "SAVINGS,INVESTMENT,MMF,CHAMA,M-SHWARI,SHWARI,ZIIDI,SAVINGS ACCOUNT", colorHex = getDefaultColorHex(11)),
            CategoryEntity(name = "Transfer & Cash", keywords = "SENT,TRANSFER,MPESA,POCHI,LA BIASHARA,TILL,PAYBILL,WESTERN UNION,MONEYGRAM,REMITLY,WORLDREMIT,WITHDRAW,AGENT,ATM,CASH,DEPOSIT,KCB,COOP,EQUITY,ABSA,STANCHART,NCBA,FAMILY BANK,I&M,DTB,BANK", colorHex = getDefaultColorHex(12)),
            CategoryEntity(name = "Income", keywords = "RECEIVED,DEPOSIT,SALARY,DIVIDEND,INTEREST,REFUND,COMMISSION,BONUS,STIPEND,PAYOUT,CASHBACK,GIFT,REWARD", colorHex = getDefaultColorHex(13))
        )
    }
